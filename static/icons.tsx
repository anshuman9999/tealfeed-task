...
export const Check = ({ style }: IIconProps) => {
  return (
    <svg
      style={style}
...
export const Cancel = ({ style }: IIconProps) => {
  return (
    <svg
      style={style}
      xmlns="http://www.w3.org/2000/svg"
...
export const ArrowLeft = ({ style }: IIconProps) => {
  return (
    <svg
      style={style}
      stroke="currentColor"
...
export const Moon = ({ style }: IIconProps) => {
  return (
    <svg
      style={style}
      stroke="currentColor"
...
export const Sun = ({ style }: IIconProps) => {
  return (
    <svg
      style={style}
      stroke="currentColor"
...
export const GitHub = ({ style }: IIconProps) => {
  return (
    <svg
      style={style}
      stroke="currentColor"
...
export const Linkedin = ({ style }: IIconProps) => {
  return (
    <svg
      style={style}
      stroke="currentColor"
